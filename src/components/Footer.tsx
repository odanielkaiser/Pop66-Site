      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="border-t border-white/5 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} Pop66. Todos os direitos reservados.
          </p>
          <div className="flex items-center gap-4">
            ...
            <Link href="https://www.instagram.com/pop66aracruz?utm_source=qr" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-primary transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
